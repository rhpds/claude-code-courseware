...
Two ways to install. Same 13 learning modules.
...
Two ways to install. Same 13 learning modules. Clone for development, install as a plugin for instant access.

Tags: Plugin, Clone, 13 Modules, MCP Servers, Skills
...
## Slide 5 -- 13 Modules Available

**Foundations:**
01 Vertex AI Setup, 02 Atlassian MCP (Jira), 03 Memory MCP, 04 Git MCP, 05 Writing CLAUDE.md, 06 Playwright MCP

**Advanced:**
07 Writing Custom Skills, 08 Hivemind Knowledge Base, 11 Building MCP Servers, 12 Review Agents, 13 Red Hat Quick Deck, 14 Agent Teams vs Superpowers, 15 Profile Cleanup
