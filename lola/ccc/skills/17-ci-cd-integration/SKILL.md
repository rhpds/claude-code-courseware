---
name: 17-ci-cd-integration
description: "Use Claude Code in CI/CD pipelines — GitHub Actions and OpenShift Pipelines — for automated code review, testing, and deployment assistance."
---
