---
description: "Learn what to do when things go wrong with Claude Code."
---

# Debugging and Troubleshooting

Learn what to do when things go wrong with Claude Code.
Estimated time: 15 minutes.

Read ../skills/14-debugging-troubleshooting/SKILL.md but present it in phases:
