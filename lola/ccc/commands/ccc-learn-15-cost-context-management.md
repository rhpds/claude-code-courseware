---
description: "Manage session costs, context window, and model routing."
---

# Cost and Context Management

Manage session costs, context window, and model routing.
Estimated time: 15 minutes.

Read ../skills/15-cost-context-management/SKILL.md but present it in phases:
