---
description: "Control how hard Claude thinks per task with effort levels — a cost, latency, and quality lever, scoped to what the team"
---

# Effort and Reasoning Control

Control how hard Claude thinks per task with effort levels — a cost, latency, and quality lever, scoped to what the team runs on Vertex AI (Opus 4.6 / Sonnet 4.5).
Estimated time: 10 minutes.

Read ../skills/29-effort-reasoning-control/SKILL.md but present it in phases:
