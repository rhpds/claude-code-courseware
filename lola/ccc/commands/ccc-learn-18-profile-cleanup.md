---
description: "Audit and clean ~/.claude/ for duplicate skills, orphaned plugins, and context bloat."
---
...
Read ../skills/18-profile-cleanup/SKILL.md but present it in phases:
