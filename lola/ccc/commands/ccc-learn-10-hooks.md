---
description: "Create pre- and post-command hooks for guardrails and automation."
---

# Hooks

Create pre- and post-command hooks for guardrails and automation.
Estimated time: 15 minutes.

Read ../skills/10-hooks/SKILL.md but present it in phases:
