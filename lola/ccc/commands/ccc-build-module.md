---
description: "You are building a new learning module for the claude-code-courseware project."
---
...
2. Read `../skills/TEMPLATE.md` for the exact structure to follow.

3. Read `../skills/references/context.md` for team-specific values.
...
4b. **Detect MCP module**: If the topic contains "MCP" or the user mentions
    ...
    section from `../skills/TEMPLATE.md` instead of the generic Preflight and Step 1.
...
5. Generate the module file at `../skills/NN-TOPIC.md`.
...
7. **Auto-generate the dispatcher** at `.claude/commands/learn-NN-TOPIC.md`:
   ...
   Read ../skills/NN-TOPIC/SKILL.md but present it in phases:
   ...
   Use ../skills/references/context.md for team-specific values.
   Track progress in ~/.claude/ccc-courseware-progress/.
   ```
...
11. Commit all generated files:
    ...
    ```bash
    git add ../skills/NN-TOPIC.md .claude/commands/learn-NN-TOPIC.md .claude/commands/ccc-courseware.md README.md
