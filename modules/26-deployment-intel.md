<!-- NEW -->
# Module 26 -- Deployment Intelligence

Estimated time: 20 minutes
Prerequisites: Module 01 (Claude Code installed and working), Module 23 recommended (RHDP-Flow MCP -- for context on the Flow ecosystem), Module 25 recommended (CSV Pipeline -- for context on offline CSV tools)
...
Module 25 covered the offline half -- CSV processing. This module covers
...
if curl -sf http://localhost:8000/api/health --max-time 5 >/dev/null 2>&1; then
  ...
  echo ""
  echo "  FULL EXPERIENCE (recommended):"
  echo "    Start the Flow API backend (see Module 23 or the rhdp-flow docs)."
...
Next module: /learn-27-workshop-intake
